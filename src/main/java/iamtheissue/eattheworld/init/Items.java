...
public class Items
{
	...
	public static Item cooked_ocelot_meat;
	...
	public static Item ocelot_hide;
	...
	public static Item raw_ocelot_meat;
	...
	public static void init()
	{
		...
		cooked_bat = new ItemFood(4, 0.75f, false).setUnlocalizedName("cooked_bat");
		cooked_ghast_meat = new ItemFood(10, 0.75f, false).setUnlocalizedName("cooked_ghast_meat");
		cooked_horse_meat = new ItemFood(8, 0.75f, false).setUnlocalizedName("cooked_horse_meat");
		cooked_human_meat = new ItemFood(6, 0.75f, false).setUnlocalizedName("cooked_human_meat");
		cooked_ocelot_meat = new ItemFood(5, 0.75f, false).setUnlocalizedName("cooked_ocelot_meat");
		cooked_silverfish = new ItemFood(2, 0.75f, false).setUnlocalizedName("cooked_silverfish");
		cooked_spider_eye = new ItemFood(2, 0.75f, false).setUnlocalizedName("cooked_spider_eye");
		cooked_spider_leg = new ItemFood(3, 0.75f, false).setUnlocalizedName("cooked_spider_leg");
		cooked_squid_meat = new ItemFood(3, 0.75f, false).setUnlocalizedName("cooked_squid_meat");
		cooked_wolf_meat = new ItemFood(6, 0.75f, false).setUnlocalizedName("cooked_wolf_meat");
		...
		heart_of_gold = new EffectFood(0, 0f, 11, 600, 3, true).setUnlocalizedName("heart_of_gold");
		...
		ocelot_hide = new Item().setUnlocalizedName("ocelot_hide");
		...
		raw_ocelot_meat = new ItemFood(2, 0.25f, false).setUnlocalizedName("raw_ocelot_meat");
	...
	public static void register()
	{
		...
		GameRegistry.registerItem(cooked_ocelot_meat, cooked_ocelot_meat.getUnlocalizedName().substring(5));
		...
		GameRegistry.registerItem(ocelot_hide, ocelot_hide.getUnlocalizedName().substring(5));
		...
		GameRegistry.registerItem(raw_ocelot_meat, raw_ocelot_meat.getUnlocalizedName().substring(5));
	...
	public static void registerRenders()
	{
		...
		registerRender(cooked_ocelot_meat);
		...
		registerRender(raw_ocelot_meat);
